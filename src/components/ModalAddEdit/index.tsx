...
import './styles';
import { ContainerModalInsert, ButtonsConfirm } from './styles';
...
const ModalInsertAndEditContact: React.FC<ContactModalProps> = ({contactId, onClose }) => {
  ...
  return (
    <div
      ...
      style={{ display: 'flex' }}
    >
      <ContainerModalInsert onSubmit={handleSubmit} className="container-modal-insert">
        <input
          type="text"
          name="name"
          placeholder="Nome"
        ...
        <ButtonsConfirm className="buttons-confirm">
